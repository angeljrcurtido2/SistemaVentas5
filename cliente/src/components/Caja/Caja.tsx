...
const CajaComponent: React.FC = () => {
    ...
    const abrirCaja = async () => {
        try {
            ...
            alert(`Error al abrir la caja si ya tiene una caja abierta y aun no la a cerrado por favor cierrela para habilitar otra`);
        }
    };
    ...
    const anularCaja = async (id: string) => {
        try {
            ...
            alert("Caja anulada con éxito")
            obtenerCajas();
            obtenerCajasAbiertos();
        } catch (error) {
            alert(`Error al anular la caja`);
        }
    };
    ...
    const calcularTotales = async () => {
        try {
            ...
            alert(`Error al calcular los totales`);
        }
    };
